...
#define ORIGINAL_FILE_NAME "UE4Editor-UE4RelativityGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME UE4RelativityGame
#define DEPRECATED_FORGAME DEPRECATED
#define UE4RELATIVITYGAME_API DLLEXPORT
